...
func snippetView(w http.ResponseWriter, r *http.Request) {
	w.Write([]byte("Displaying a specific snippet... ")) // what this line does I have to be clear in future once understanding the fundamentals of the language
}

func snippetCreate(w http.ResponseWriter, r *http.Request) {
	w.Write([]byte("Creating a new snippet... ")) // what this line does I have to be clear in future once understanding the fundamentals of the language
}
